function Gamma_array = SEIR_Gamma_discrete(y_experi, Gamma)
...
%
% Note: Here, the input Gamma is a function handle in terms of t. This Gamma is
% obtained from the optimisation stages. 
